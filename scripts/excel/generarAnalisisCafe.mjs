...
// ============================================================
{
  const data = [
    ...
    [],
    [{ v: 'PARÁMETROS CLAVE DEL MODELO', s: { font: { bold: true, sz: 12 } } }],
    [],
    ['Variable', 'Valor', 'Fundamento'],
    ['Costo variable por combo', 'Variable por zona $1.300-$1.700', 'Espresso + alimento envasado + empaques + descartables ≈ 40-50% del ticket'],
    ['Costos fijos no laborales', '$850k/mes (sin arriendo)', 'Marketing $200k + aseo/pest $100k + software/contador $150k + seguros/mantenciones $150k + servicios $250k'],
    ['Comisión tarjetas', '2.8% sobre ingresos', 'Transbank/Getnet ~3.5% sobre ~80% de pago electrónico observado'],
    ['Crecimiento demanda', '2.5% anual sectorial', 'Procafé Chile reporta consumo creciente 4-6%; aplicamos rango bajo conservador'],
    ['Valor terminal', 'Múltiplo EBITDA 3.5x', 'Rango M&A retail food Chile 3-5x; tomamos extremo bajo'],
    ['Tasa de descuento (Tcc)', '14%', 'CAPM: Rf 5.5% (BTU 10y) + β 1.3 × ERP 6.5% (Damodaran 2024)'],
    [],
...
// ============================================================
{
  ...
  const data = [
    ...
    [],
    ['Bajo el modelo financiero aplicado (costos fijos a precio de mercado, comisión de tarjetas, valor terminal'],
    ['por múltiplo EBITDA y Tcc 14% para retail food), solo 1 de las 7 ubicaciones evaluadas ofrece VAN claramente positivo y resiliente.'],
    [''],
